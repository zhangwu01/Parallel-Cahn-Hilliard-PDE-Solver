...
# Job script to measure performance for OpenMP multi thread performance
# Copyright 2023 Harvard University. All Rights Reserved.
#SBATCH --job-name=cs205_team13_check_threads_anqi
#SBATCH --output=team13_check%j_threads_anqi.out
