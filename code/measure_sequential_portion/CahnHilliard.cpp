    ...
    : nodes_(N)
{
    ...
    // std::cout<<"My cart coords is "<< mpi_coords_[0] << ","<< mpi_coords_[1] <<"\n";
    // std::cout<<"Top neighbor is "<<neighbor_[Top]<<"\n";
    // std::cout<<"Bottom neighbor is "<<neighbor_[Bottom]<<"\n";
    // std::cout<<"Left neighbor is "<<neighbor_[Left]<<"\n";
    // std::cout<<"Right neighbor is "<<neighbor_[Right]<<"\n";

    // std::cout<<"Top Left neighbor is "<<neighbor_[LT]<<"\n";
    // std::cout<<"Top Right neighbor is "<<neighbor_[RT]<<"\n";
    // std::cout<<"Bottom Left neighbor is "<<neighbor_[LB]<<"\n";
    // std::cout<<"Bottom Right neighbor is "<<neighbor_[RB]<<"\n";
    // std::cout<<"===================="<<"\n";
    // // print rank information //
    // ////////////////////////////////////////////////////////
...
// Public methods
void CahnHilliard::dump(const std::string fname)
{
    MPI_File fh;
    MPI_Status st;
